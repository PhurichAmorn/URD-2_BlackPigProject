...
class PigMeasurements {
  ...
  static PigMeasurements? fromMask(
    ...
    return PigMeasurements(
      ...
      lengthP1: p1,
      lengthP2: p2,
      topA: Offset(topCenter.dx + bx * topResult.minPerp, topCenter.dy + by * topResult.minPerp),
      topB: Offset(topCenter.dx + bx * topResult.maxPerp, topCenter.dy + by * topResult.maxPerp),
      midA: Offset(midCenter.dx + bx * midResult.minPerp, midCenter.dy + by * midResult.minPerp),
      midB: Offset(midCenter.dx + bx * midResult.maxPerp, midCenter.dy + by * midResult.maxPerp),
      botA: Offset(botCenter.dx + bx * botResult.minPerp, botCenter.dy + by * botResult.minPerp),
      botB: Offset(botCenter.dx + bx * botResult.maxPerp, botCenter.dy + by * botResult.maxPerp),
    );
  }
